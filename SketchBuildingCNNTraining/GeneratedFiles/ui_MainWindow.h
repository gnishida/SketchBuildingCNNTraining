...
public:
    ...
    {
        MainWindowClass->setWindowTitle(QApplication::translate("MainWindowClass", "Sketch Building CNN Training", 0));
        ...
        actionPrediction->setText(QApplication::translate("MainWindowClass", "Prediction", 0));
